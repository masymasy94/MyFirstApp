...
class MonstersDatabaseOpenHelper (context: Context, factory: SQLiteDatabase.CursorFactory?) :
    SQLiteOpenHelper(context,
        MonstersDatabaseOpenHelper.DATABASE_NAME, factory,
        MonstersDatabaseOpenHelper.DATABASE_VERSION){
    ...
    fun addMonster(monster: Monster) {
        ...
        values.put(COLUMN_DESCRIPTION, monster.description)
    ...
    fun getMonsters(): List<Monster> {
        ...
        if (cursor != null) {
            var monster : Monster = Monster(
                ...
                cursor.getInt(cursor.getColumnIndex(COLUMN_CHALLANGE)),
    ...
    fun query(projection: Array<String>, selection: String, selectionArgs: Array<String>, sorOrder: String): Cursor {
        ...
        qb.tables = ItemsDatabaseOpenHelper.TABLE_NAME
        return this.readableDatabase.query(ItemsDatabaseOpenHelper.TABLE_NAME, projection, selection, selectionArgs, null, null, sorOrder)

    }

    fun delete(selection: String, selectionArgs: Array<String>): Int {
        return this.writableDatabase.delete(ItemsDatabaseOpenHelper.TABLE_NAME, selection, selectionArgs)

    }

    fun update(values: ContentValues, selection: String, selectionArgs: Array<String>): Int {
        return this.writableDatabase.update(ItemsDatabaseOpenHelper.TABLE_NAME, values, selection, selectionArgs)
    }
